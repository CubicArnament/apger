...
print_banner() {
    local C1='\033[38;2;0;210;230m'    # cyan
    local C2='\033[38;2;0;180;220m'
    local C3='\033[38;2;25;150;225m'
    local C4='\033[38;2;50;120;228m'
    local C5='\033[38;2;50;108;229m'   # k8s blue
    local W='\033[1;97m'               # bright white
    local BG='\033[48;2;50;108;229m'   # k8s blue bg
    local NC='\033[0m'

    # K8s helm wheel (white on blue bg)
    local K="${BG}${W}"

    echo -e ""
    echo -e "  ${C1}███╗   ██╗███████╗███████╗${NC}   ${C1}╔═══╦═══╦═══╦═══╦═══╦═══╦═══╦═══╗${NC}   ${K}    .  .    ${NC}"
    echo -e "  ${C2}████╗  ██║██╔════╝██╔════╝${NC}   ${C2}║   ║   ║   ║   ║   ║   ║   ║   ║${NC}   ${K}  .'|  |'.  ${NC}"
    echo -e "  ${C3}██╔██╗ ██║█████╗  ███████╗${NC}   ${C3}╠═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╣${NC}   ${K} /  (    )  \\${NC}"
    echo -e "  ${C4}██║╚██╗██║██╔══╝  ╚════██║${NC}   ${C4}║   ║   ║   ║   ║   ║   ║   ║   ║${NC}   ${K}|---.    .---|${NC}"
    echo -e "  ${C5}██║ ╚████║██║     ███████║${NC}   ${C5}╚═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╝${NC}   ${K}|---.    .---|${NC}"
    echo -e "  ${C5}╚═╝  ╚═══╝╚═╝     ╚══════╝${NC}                                          ${K} \\  (    )  /${NC}"
    echo -e "                                                                     ${K}  '.| .' |.'  ${NC}"
    echo -e "                                                                     ${K}    '  '    ${NC}"
    echo -e ""
    ...
    echo -e "  ${C2}║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║   ║${NC}"
    echo -e "  ${C3}╠═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╬═══╣${NC}"
    echo -e "  ${C4}║   ${W}Kubernetes${NC}${C4}  ·  ${W}NFS${NC}${C4}  ·  ${W}Configurer${NC}${C4}  ·  ${W}APGer${NC}${C4}  ·  ${W}NurOS${NC}${C4}   ║${NC}"
    echo -e "  ${C5}╚═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╩═══╝${NC}"
    echo -e ""
}
