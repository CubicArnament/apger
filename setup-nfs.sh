...
print_banner() {
    local NFS='\033[38;2;255;180;0m'
    local K8S='\033[38;2;50;108;229m'
    local G1='\033[38;2;255;180;0m'
    local G2='\033[38;2;200;150;80m'
    local G3='\033[38;2;130;120;160m'
    local G4='\033[38;2;50;108;229m'
    local W='\033[1;37m'
    local NC='\033[0m'

    echo -e ""
    echo -e "  ${NFS} _  _ ___  ___   ${NC}${NFS}╔══════════════════════════════════╗${NC}  ${K8S} _  ___  ___  ${NC}"
    echo -e "  ${NFS}| \| | __/' _/   ${NC}${NFS}║${NC}  ${G1}K${G2}u${G3}b${G4}e${G3}r${G2}n${G1}e${G2}t${G3}e${G4}s${NC} ${W}·${NC} ${G4}N${G3}F${G2}S${NC} ${W}·${NC} ${G1}C${G2}o${G3}n${G4}f${G3}i${G2}g${G1}u${G2}r${G3}e${G4}r${NC}  ${K8S}║${NC}  ${K8S}| |/ / __|/ __| ${NC}"
    echo -e "  ${NFS}| .  | _| \_ \   ${NC}${K8S}╚══════════════════════════════════╝${NC}  ${K8S}| ' <\__ \\__ \ ${NC}"
    echo -e "  ${NFS}|_|\_|_| |___/   ${NC}                                      ${K8S}|_|\_\___/___/ ${NC}"
    echo -e ""
}
