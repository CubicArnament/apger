"""
Модуль для преобразования общих флагов в аргументы конкретных систем сборки
"""
...
class FlagTranslator:
    """
    Класс для преобразования общих флагов в аргументы конкретных систем сборки
    """
    ...
    def translate_flags(self, build_system: str, use_flags: List[str]) -> List[str]:
        """
        Преобразует общие флаги в аргументы для конкретной системы сборки
        """
