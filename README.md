...
|---------|---------|------|-------------|---------|-------|
| [bash](https://www.gnu.org/software/bash/) | `5.3` | 🔵 core | GNU Bourne Again Shell — the standard interactive and scr... | GPL-3.0-or-later | autotools |
| [binutils](https://www.gnu.org/software/binutils/) | `2.46.0` | 🔵 core | GNU Binutils — collection of binary tools including assem... | GPL-3.0-or-later | autotools |
| [bzip2](https://sourceware.org/bzip2/) | `1.0.8` | 🔵 core | bzip2 — high-quality block-sorting file compressor using ... | bzip2-1.0.6 | makefile |
| [coreutils](https://www.gnu.org/software/coreutils/) | `9.11` | 🔵 core | GNU Core Utilities — essential file, shell, and text mani... | GPL-3.0-or-later | autotools |
| [dbus](https://www.freedesktop.org/wiki/Software/dbus/) | `1.16.2` | 🔵 core | D-Bus — message bus system for inter-process communicatio... | AFL-2.1 OR GPL-2.0-or-later | autotools |
| [gcc](https://gcc.gnu.org/) | `15.2.0` | 🔵 core | GNU Compiler Collection — optimising compilers for C, C++... | GPL-3.0-or-later | autotools |
| [glibc](https://www.gnu.org/software/libc/) | `2.43` | 🔵 core | GNU C Library — the standard C library for Linux; provide... | LGPL-2.1-or-later | autotools |
...
| [curl](https://curl.se) | `8.19.0` | 🟢 main | Command line tool and library for transferring data with ... | curl | autotools |
...
| [git](https://git-scm.com) | `2.49.0` | 🟢 main | Fast, scalable, distributed revision control system | GPL-2.0 | autotools |
| [glib2](https://docs.gtk.org/glib/) | `2.80.0` | 🟢 main | Low-level core library for GNOME | LGPL-2.1 | meson |
| [htop](https://htop.dev) | `3.5.0` | 🟢 main | Interactive process viewer with a color display and mouse... | GPL-2.0 | autotools |
...
| [nano](https://www.nano-editor.org) | `9.0` | 🟢 main | Small, friendly text editor inspired by Pico | GPL-3.0 | autotools |
...
| [openssh](https://www.openssh.com) | `10.3p1` | 🟢 main | OpenBSD Secure Shell client and utilities for encrypted r... | BSD-2-Clause | autotools |
...
| [python3](https://www.python.org) | `3.13.3` | 🟢 main | High-level, general-purpose programming language with dyn... | PSF-2.0 | autotools |
...
| [vim](https://www.vim.org) | `9.2.0368` | 🟢 main | Highly configurable text editor built to enable efficient... | Vim | autotools |
| [wget](https://www.gnu.org/software/wget/) | `1.25.0` | 🟢 main | Non-interactive network downloader supporting HTTP, HTTPS... | GPL-3.0 | autotools |
...
| [containerd](https://containerd.io) | `2.0.4` | 🟡 extra | Industry-standard container runtime | Apache-2.0 | makefile |
...
| [docker](https://docker.com) | `29.0.3` | 🟡 extra | Container platform for building, shipping and running app... | Apache-2.0 | makefile |
| [ffmpeg](https://ffmpeg.org) | `7.1.1` | 🟡 extra | Complete, cross-platform solution to record, convert and ... | LGPL-2.1 | makefile |
...
| [go](https://go.dev) | `1.26.2` | 🟡 extra | The Go programming language compiler and tools | BSD-3-Clause | makefile |
| [gstreamer](https://gstreamer.freedesktop.org) | `1.24.3` | 🟡 extra | Pipeline-based multimedia framework | LGPL-2.1 | meson |
| [gtk3](https://gtk.org) | `3.24.52` | 🟡 extra | GTK+ 3 graphical user interface toolkit | LGPL-2.1 | meson |
| [gtk4](https://gtk.org) | `4.20.4` | 🟡 extra | GTK 4 graphical user interface toolkit | LGPL-2.1 | meson |
...
| [mesa](https://mesa3d.org) | `26.0.5` | 🟡 extra | Open-source OpenGL, Vulkan and other graphics API impleme... | MIT | meson |
| [nettle](https://lysator.liu.se/~nisse/nettle) | `3.10` | 🟡 extra | Low-level cryptographic library | LGPL-3.0 | autotools |
| [nodejs](https://nodejs.org) | `22.15.0` | 🟡 extra | JavaScript runtime built on Chrome's V8 engine | MIT | makefile |
...
| [podman](https://podman.io) | `5.7.0` | 🟡 extra | Daemonless container engine for managing OCI containers | Apache-2.0 | makefile |
...
| [qt6-base](https://qt.io) | `6.9.3` | 🟡 extra | Qt6 base libraries and tools | LGPL-3.0 | cmake |
| [ruby](https://ruby-lang.org) | `3.3.1` | 🟡 extra | Dynamic, open source programming language with a focus on... | Ruby | autotools |
| [rust](https://rust-lang.org) | `1.87.0` | 🟡 extra | Systems programming language focused on safety and perfor... | MIT | makefile |
...
| [vulkan-loader](https://github.com/KhronosGroup/Vulkan-Loader) | `1.4.309` | 🟡 extra | Vulkan ICD (Installable Client Driver) loader | Apache-2.0 | cmake |
| [wayland](https://wayland.freedesktop.org) | `1.25.0` | 🟡 extra | Wayland display server protocol and library | MIT | meson |
